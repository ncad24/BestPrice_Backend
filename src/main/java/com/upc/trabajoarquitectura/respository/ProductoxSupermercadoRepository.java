...
public interface ProductoxSupermercadoRepository extends JpaRepository<ProductoxSupermercado, ProductoxSupermercadoID> {
    ...
    public ProductoxSupermercado findByPrimaryKey_Producto_ProductoIDAndPrimaryKey_Supermercado_SupermercadoID(Long productoId, Long supermercadoID);
    ...
    public List<ProductoSupermercadoDTO> findPricesProductsForEachSupermarket(@Param("idProduct") Long idProduct);
    ...
    public List<PrecioProductosSupermercadoDTO> findMinPricesForProductsBySupermarket();
    ...
    public List<PrecioProductosSupermercadoDTO> findMinPricesForProductsBySupermarketBetweenPrices(@Param("precioMin") double precioMin, @Param("precioMax") double precioMax);
    ...
    public List<PrecioProductosSupermercadoDTO> findMinPricesForProductsBySupermarketOrderAsc();
}
